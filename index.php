...
<html lang="en-US">
<head>
<title>Сайт Программиста Василя Салькова</title>
<meta charset="utf-8">
<meta name="description" content="Хороший и молодой программист из Беларуси">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Прогроммист из Беларуси<br></h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
							Сайт был написан на основе PHP и HTML а всё другое CSS
							</p>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
							       Discord - это идеально (Сервер пока что не работает)
								</p>
							</div>
